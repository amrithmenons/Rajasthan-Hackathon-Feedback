...
function FeedbackForm() {
    ...
    const validateForm = () => {
        ...
        if (!name) {
            ...
            setErrorMsg('Passport Number should have 12 alphanumeric characters');
        } else if (identification === 'aadhar' && (!/^\d{12}$/.test(cardNumber))) {
            document.getElementById('cardNumber_er').style.display = 'block';
            setErrorMsg('Aadhar Number should have 12 digits');
        } else if (identification === 'pancard' && (!/^[a-zA-Z0-9]{10}$/.test(cardNumber))) {
            document.getElementById('cardNumber_er').style.display = 'block';
            setErrorMsg('PAN Card Number should have 10 alphanumeric characters');
        }else if (identification === 'driver_license' && (!/^[a-zA-Z0-9\s-]{16}$/.test(cardNumber))) {
            document.getElementById('cardNumber_er').style.display = 'block';
            setErrorMsg('Driver\'s License should have 16 alphanumeric characters, including spaces or dashes');
        }
                                ...
                                <Col>
                                    <Form.Group className="mb-3" controlId="formBasicIdentification">
                                        ...
                                        >
                                            ...
                                            <option value="other">Others</option> {/* Add PAN Card option */}
